...
import com.bsp.iqtest.iqtest.R;
...
public class MagicTextView extends TextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_customForeground)){
                Drawable foreground = a.getDrawable(R.styleable.MagicTextView_customForeground);
                if(foreground != null){
                    this.setForegroundDrawable(foreground);
                }else{
                    this.setTextColor(a.getColor(R.styleable.MagicTextView_customForeground, 0xff000000));
                }
            }
